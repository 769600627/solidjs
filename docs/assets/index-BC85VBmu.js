(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(r){if(r.ep)return;r.ep=!0;const a=n(r);fetch(r.href,a)}})();const Ot=!1,At=(e,t)=>e===t,pe=Symbol("solid-proxy"),Je=typeof Proxy=="function",$t=Symbol("solid-track"),de={equals:At};let Ze=st;const U=1,ue=2,et={owned:null,cleanups:null,context:null,owner:null};var x=null;let _e=null,kt=null,C=null,I=null,H=null,fe=0;function Y(e,t){const n=C,o=x,r=e.length===0,a=t===void 0?o:t,i=r?et:{owned:null,cleanups:null,context:a?a.context:null,owner:a},s=r?e:()=>e(()=>R(()=>J(i)));x=i,C=null;try{return G(s,!0)}finally{C=n,x=o}}function T(e,t){t=t?Object.assign({},de,t):de;const n={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=r=>(typeof r=="function"&&(r=r(n.value)),ot(n,r));return[rt.bind(n),o]}function N(e,t,n){const o=De(e,t,!1,U);ne(o)}function It(e,t,n){Ze=Ft;const o=De(e,t,!1,U);o.user=!0,H?H.push(o):ne(o)}function k(e,t,n){n=n?Object.assign({},de,n):de;const o=De(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=n.equals||void 0,ne(o),rt.bind(o)}function Et(e){return G(e,!1)}function R(e){if(C===null)return e();const t=C;C=null;try{return e()}finally{C=t}}function Te(e,t,n){const o=Array.isArray(e);let r,a=n&&n.defer;return i=>{let s;if(o){s=Array(e.length);for(let c=0;c<e.length;c++)s[c]=e[c]()}else s=e();if(a)return a=!1,i;const l=R(()=>t(s,r,i));return r=s,l}}function D(e){It(()=>R(e))}function j(e){return x===null||(x.cleanups===null?x.cleanups=[e]:x.cleanups.push(e)),e}function tt(){return x}function nt(e,t){const n=x,o=C;x=e,C=null;try{return G(t,!0)}catch(r){Fe(r)}finally{x=n,C=o}}function Tt(e){const t=C,n=x;return Promise.resolve().then(()=>{C=t,x=n;let o;return G(e,!1),C=x=null,o?o.done:void 0})}const[co,po]=T(!1);function ge(e,t){const n=Symbol("context");return{id:n,Provider:Rt(n),defaultValue:e}}function te(e){let t;return x&&x.context&&(t=x.context[e.id])!==void 0?t:e.defaultValue}function Ne(e){const t=k(e),n=k(()=>Oe(t()));return n.toArray=()=>{const o=n();return Array.isArray(o)?o:o!=null?[o]:[]},n}function rt(){if(this.sources&&this.state)if(this.state===U)ne(this);else{const e=I;I=null,G(()=>he(this),!1),I=e}if(C){const e=this.observers?this.observers.length:0;C.sources?(C.sources.push(this),C.sourceSlots.push(e)):(C.sources=[this],C.sourceSlots=[e]),this.observers?(this.observers.push(C),this.observerSlots.push(C.sources.length-1)):(this.observers=[C],this.observerSlots=[C.sources.length-1])}return this.value}function ot(e,t,n){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&G(()=>{for(let r=0;r<e.observers.length;r+=1){const a=e.observers[r],i=_e&&_e.running;i&&_e.disposed.has(a),(i?!a.tState:!a.state)&&(a.pure?I.push(a):H.push(a),a.observers&&at(a)),i||(a.state=U)}if(I.length>1e6)throw I=[],new Error},!1)),t}function ne(e){if(!e.fn)return;J(e);const t=fe;Nt(e,e.value,t)}function Nt(e,t,n){let o;const r=x,a=C;C=x=e;try{o=e.fn(t)}catch(i){return e.pure&&(e.state=U,e.owned&&e.owned.forEach(J),e.owned=null),e.updatedAt=n+1,Fe(i)}finally{C=a,x=r}(!e.updatedAt||e.updatedAt<=n)&&(e.updatedAt!=null&&"observers"in e?ot(e,o):e.value=o,e.updatedAt=n)}function De(e,t,n,o=U,r){const a={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:x,context:x?x.context:null,pure:n};return x===null||x!==et&&(x.owned?x.owned.push(a):x.owned=[a]),a}function me(e){if(e.state===0)return;if(e.state===ue)return he(e);if(e.suspense&&R(e.suspense.inFallback))return e.suspense.effects.push(e);const t=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<fe);)e.state&&t.push(e);for(let n=t.length-1;n>=0;n--)if(e=t[n],e.state===U)ne(e);else if(e.state===ue){const o=I;I=null,G(()=>he(e,t[0]),!1),I=o}}function G(e,t){if(I)return e();let n=!1;t||(I=[]),H?n=!0:H=[],fe++;try{const o=e();return Dt(n),o}catch(o){n||(H=null),I=null,Fe(o)}}function Dt(e){if(I&&(st(I),I=null),e)return;const t=H;H=null,t.length&&G(()=>Ze(t),!1)}function st(e){for(let t=0;t<e.length;t++)me(e[t])}function Ft(e){let t,n=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[n++]=o:me(o)}for(t=0;t<n;t++)me(e[t])}function he(e,t){e.state=0;for(let n=0;n<e.sources.length;n+=1){const o=e.sources[n];if(o.sources){const r=o.state;r===U?o!==t&&(!o.updatedAt||o.updatedAt<fe)&&me(o):r===ue&&he(o,t)}}}function at(e){for(let t=0;t<e.observers.length;t+=1){const n=e.observers[t];n.state||(n.state=ue,n.pure?I.push(n):H.push(n),n.observers&&at(n))}}function J(e){let t;if(e.sources)for(;e.sources.length;){const n=e.sources.pop(),o=e.sourceSlots.pop(),r=n.observers;if(r&&r.length){const a=r.pop(),i=n.observerSlots.pop();o<r.length&&(a.sourceSlots[i]=o,r[o]=a,n.observerSlots[o]=i)}}if(e.tOwned){for(t=e.tOwned.length-1;t>=0;t--)J(e.tOwned[t]);delete e.tOwned}if(e.owned){for(t=e.owned.length-1;t>=0;t--)J(e.owned[t]);e.owned=null}if(e.cleanups){for(t=e.cleanups.length-1;t>=0;t--)e.cleanups[t]();e.cleanups=null}e.state=0}function Lt(e){return e instanceof Error?e:new Error(typeof e=="string"?e:"Unknown error",{cause:e})}function Fe(e,t=x){throw Lt(e)}function Oe(e){if(typeof e=="function"&&!e.length)return Oe(e());if(Array.isArray(e)){const t=[];for(let n=0;n<e.length;n++){const o=Oe(e[n]);Array.isArray(o)?t.push.apply(t,o):t.push(o)}return t}return e}function Rt(e,t){return function(o){let r;return N(()=>r=R(()=>(x.context={...x.context,[e]:o.value},Ne(()=>o.children))),void 0),r}}const Mt=Symbol("fallback");function Ge(e){for(let t=0;t<e.length;t++)e[t]()}function Ht(e,t,n={}){let o=[],r=[],a=[],i=0,s=t.length>1?[]:null;return j(()=>Ge(a)),()=>{let l=e()||[],c=l.length,p,d;return l[$t],R(()=>{let h,v,f,b,_,y,O,A,E;if(c===0)i!==0&&(Ge(a),a=[],o=[],r=[],i=0,s&&(s=[])),n.fallback&&(o=[Mt],r[0]=Y(W=>(a[0]=W,n.fallback())),i=1);else if(i===0){for(r=new Array(c),d=0;d<c;d++)o[d]=l[d],r[d]=Y(m);i=c}else{for(f=new Array(c),b=new Array(c),s&&(_=new Array(c)),y=0,O=Math.min(i,c);y<O&&o[y]===l[y];y++);for(O=i-1,A=c-1;O>=y&&A>=y&&o[O]===l[A];O--,A--)f[A]=r[O],b[A]=a[O],s&&(_[A]=s[O]);for(h=new Map,v=new Array(A+1),d=A;d>=y;d--)E=l[d],p=h.get(E),v[d]=p===void 0?-1:p,h.set(E,d);for(p=y;p<=O;p++)E=o[p],d=h.get(E),d!==void 0&&d!==-1?(f[d]=r[p],b[d]=a[p],s&&(_[d]=s[p]),d=v[d],h.set(E,d)):a[p]();for(d=y;d<c;d++)d in f?(r[d]=f[d],a[d]=b[d],s&&(s[d]=_[d],s[d](d))):r[d]=Y(m);r=r.slice(0,i=c),o=l.slice(0)}return r});function m(h){if(a[d]=h,s){const[v,f]=T(d);return s[d]=f,t(l[d],v)}return t(l[d])}}}function u(e,t){return R(()=>e(t||{}))}function le(){return!0}const Ae={get(e,t,n){return t===pe?n:e.get(t)},has(e,t){return t===pe?!0:e.has(t)},set:le,deleteProperty:le,getOwnPropertyDescriptor(e,t){return{configurable:!0,enumerable:!0,get(){return e.get(t)},set:le,deleteProperty:le}},ownKeys(e){return e.keys()}};function xe(e){return(e=typeof e=="function"?e():e)?e:{}}function Ut(){for(let e=0,t=this.length;e<t;++e){const n=this[e]();if(n!==void 0)return n}}function $e(...e){let t=!1;for(let i=0;i<e.length;i++){const s=e[i];t=t||!!s&&pe in s,e[i]=typeof s=="function"?(t=!0,k(s)):s}if(Je&&t)return new Proxy({get(i){for(let s=e.length-1;s>=0;s--){const l=xe(e[s])[i];if(l!==void 0)return l}},has(i){for(let s=e.length-1;s>=0;s--)if(i in xe(e[s]))return!0;return!1},keys(){const i=[];for(let s=0;s<e.length;s++)i.push(...Object.keys(xe(e[s])));return[...new Set(i)]}},Ae);const n={},o=Object.create(null);for(let i=e.length-1;i>=0;i--){const s=e[i];if(!s)continue;const l=Object.getOwnPropertyNames(s);for(let c=l.length-1;c>=0;c--){const p=l[c];if(p==="__proto__"||p==="constructor")continue;const d=Object.getOwnPropertyDescriptor(s,p);if(!o[p])o[p]=d.get?{enumerable:!0,configurable:!0,get:Ut.bind(n[p]=[d.get.bind(s)])}:d.value!==void 0?d:void 0;else{const m=n[p];m&&(d.get?m.push(d.get.bind(s)):d.value!==void 0&&m.push(()=>d.value))}}}const r={},a=Object.keys(o);for(let i=a.length-1;i>=0;i--){const s=a[i],l=o[s];l&&l.get?Object.defineProperty(r,s,l):r[s]=l?l.value:void 0}return r}function jt(e,...t){const n=t.length;if(Je&&pe in e){const r=n>1?t.flat():t[0],a=t.map(i=>new Proxy({get(s){return i.includes(s)?e[s]:void 0},has(s){return i.includes(s)&&s in e},keys(){return i.filter(s=>s in e)}},Ae));return a.push(new Proxy({get(i){return r.includes(i)?void 0:e[i]},has(i){return r.includes(i)?!1:i in e},keys(){return Object.keys(e).filter(i=>!r.includes(i))}},Ae)),a}const o=[];for(let r=0;r<=n;r++)o[r]={};for(const r of Object.getOwnPropertyNames(e)){let a=n;for(let l=0;l<t.length;l++)if(t[l].includes(r)){a=l;break}const i=Object.getOwnPropertyDescriptor(e,r);!i.get&&!i.set&&i.enumerable&&i.writable&&i.configurable?o[a][r]=i.value:Object.defineProperty(o[a],r,i)}return o}let Gt=0;function Wt(){return`cl-${Gt++}`}const qt=e=>`Stale read from <${e}>.`;function Se(e){const t="fallback"in e&&{fallback:()=>e.fallback};return k(Ht(()=>e.each,e.children,t||void 0))}function it(e){const t=e.keyed,n=k(()=>e.when,void 0,void 0),o=t?n:k(n,void 0,{equals:(r,a)=>!r==!a});return k(()=>{const r=o();if(r){const a=e.children;return typeof a=="function"&&a.length>0?R(()=>a(t?r:()=>{if(!R(o))throw qt("Show");return n()})):a}return e.fallback},void 0,void 0)}const Bt=["allowfullscreen","async","alpha","autofocus","autoplay","checked","controls","default","disabled","formnovalidate","hidden","indeterminate","inert","ismap","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","seamless","selected","adauctionheaders","browsingtopics","credentialless","defaultchecked","defaultmuted","defaultselected","defer","disablepictureinpicture","disableremoteplayback","preservespitch","shadowrootclonable","shadowrootcustomelementregistry","shadowrootdelegatesfocus","shadowrootserializable","sharedstoragewritable"],Qt=new Set(["className","value","readOnly","noValidate","formNoValidate","isMap","noModule","playsInline","adAuctionHeaders","allowFullscreen","browsingTopics","defaultChecked","defaultMuted","defaultSelected","disablePictureInPicture","disableRemotePlayback","preservesPitch","shadowRootClonable","shadowRootCustomElementRegistry","shadowRootDelegatesFocus","shadowRootSerializable","sharedStorageWritable",...Bt]),Xt=new Set(["innerHTML","textContent","innerText","children"]),Kt=Object.assign(Object.create(null),{className:"class",htmlFor:"for"}),Vt=Object.assign(Object.create(null),{class:"className",novalidate:{$:"noValidate",FORM:1},formnovalidate:{$:"formNoValidate",BUTTON:1,INPUT:1},ismap:{$:"isMap",IMG:1},nomodule:{$:"noModule",SCRIPT:1},playsinline:{$:"playsInline",VIDEO:1},readonly:{$:"readOnly",INPUT:1,TEXTAREA:1},adauctionheaders:{$:"adAuctionHeaders",IFRAME:1},allowfullscreen:{$:"allowFullscreen",IFRAME:1},browsingtopics:{$:"browsingTopics",IMG:1},defaultchecked:{$:"defaultChecked",INPUT:1},defaultmuted:{$:"defaultMuted",AUDIO:1,VIDEO:1},defaultselected:{$:"defaultSelected",OPTION:1},disablepictureinpicture:{$:"disablePictureInPicture",VIDEO:1},disableremoteplayback:{$:"disableRemotePlayback",AUDIO:1,VIDEO:1},preservespitch:{$:"preservesPitch",AUDIO:1,VIDEO:1},shadowrootclonable:{$:"shadowRootClonable",TEMPLATE:1},shadowrootdelegatesfocus:{$:"shadowRootDelegatesFocus",TEMPLATE:1},shadowrootserializable:{$:"shadowRootSerializable",TEMPLATE:1},sharedstoragewritable:{$:"sharedStorageWritable",IFRAME:1,IMG:1}});function Yt(e,t){const n=Vt[e];return typeof n=="object"?n[t]?n.$:void 0:n}const zt=new Set(["beforeinput","click","dblclick","contextmenu","focusin","focusout","input","keydown","keyup","mousedown","mousemove","mouseout","mouseover","mouseup","pointerdown","pointermove","pointerout","pointerover","pointerup","touchend","touchmove","touchstart"]),Jt={xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace"},z=e=>k(()=>e());function Zt(e,t,n){let o=n.length,r=t.length,a=o,i=0,s=0,l=t[r-1].nextSibling,c=null;for(;i<r||s<a;){if(t[i]===n[s]){i++,s++;continue}for(;t[r-1]===n[a-1];)r--,a--;if(r===i){const p=a<o?s?n[s-1].nextSibling:n[a-s]:l;for(;s<a;)e.insertBefore(n[s++],p)}else if(a===s)for(;i<r;)(!c||!c.has(t[i]))&&t[i].remove(),i++;else if(t[i]===n[a-1]&&n[s]===t[r-1]){const p=t[--r].nextSibling;e.insertBefore(n[s++],t[i++].nextSibling),e.insertBefore(n[--a],p),t[r]=n[a]}else{if(!c){c=new Map;let d=s;for(;d<a;)c.set(n[d],d++)}const p=c.get(t[i]);if(p!=null)if(s<p&&p<a){let d=i,m=1,h;for(;++d<r&&d<a&&!((h=c.get(t[d]))==null||h!==p+m);)m++;if(m>p-s){const v=t[i];for(;s<p;)e.insertBefore(n[s++],v)}else e.replaceChild(n[s++],t[i++])}else i++;else t[i++].remove()}}}const We="_$DX_DELEGATE";function en(e,t,n,o={}){let r;return Y(a=>{r=a,t===document?e():g(t,e(),t.firstChild?null:void 0,n)},o.owner),()=>{r(),t.textContent=""}}function w(e,t,n,o){let r;const a=()=>{const s=document.createElement("template");return s.innerHTML=e,s.content.firstChild},i=()=>(r||(r=a())).cloneNode(!0);return i.cloneNode=i,i}function re(e,t=window.document){const n=t[We]||(t[We]=new Set);for(let o=0,r=e.length;o<r;o++){const a=e[o];n.has(a)||(n.add(a),t.addEventListener(a,pn))}}function Z(e,t,n){n==null?e.removeAttribute(t):e.setAttribute(t,n)}function tn(e,t,n,o){o==null?e.removeAttributeNS(t,n):e.setAttributeNS(t,n,o)}function nn(e,t,n){n?e.setAttribute(t,""):e.removeAttribute(t)}function rn(e,t){t==null?e.removeAttribute("class"):e.className=t}function on(e,t,n,o){if(o)Array.isArray(n)?(e[`$$${t}`]=n[0],e[`$$${t}Data`]=n[1]):e[`$$${t}`]=n;else if(Array.isArray(n)){const r=n[0];e.addEventListener(t,n[0]=a=>r.call(e,n[1],a))}else e.addEventListener(t,n,typeof n!="function"&&n)}function sn(e,t,n={}){const o=Object.keys(t||{}),r=Object.keys(n);let a,i;for(a=0,i=r.length;a<i;a++){const s=r[a];!s||s==="undefined"||t[s]||(qe(e,s,!1),delete n[s])}for(a=0,i=o.length;a<i;a++){const s=o[a],l=!!t[s];!s||s==="undefined"||n[s]===l||!l||(qe(e,s,!0),n[s]=l)}return n}function lt(e,t,n){if(!t)return n?Z(e,"style"):t;const o=e.style;if(typeof t=="string")return o.cssText=t;typeof n=="string"&&(o.cssText=n=void 0),n||(n={}),t||(t={});let r,a;for(a in n)t[a]==null&&o.removeProperty(a),delete n[a];for(a in t)r=t[a],r!==n[a]&&(o.setProperty(a,r),n[a]=r);return n}function an(e,t,n){n!=null?e.style.setProperty(t,n):e.style.removeProperty(t)}function ke(e,t={},n,o){const r={};return o||N(()=>r.children=ee(e,t.children,r.children)),N(()=>typeof t.ref=="function"&&oe(t.ref,e)),N(()=>ln(e,t,n,!0,r,!0)),r}function oe(e,t,n){return R(()=>e(t,n))}function g(e,t,n,o){if(n!==void 0&&!o&&(o=[]),typeof t!="function")return ee(e,t,o,n);N(r=>ee(e,t(),r,n),o)}function ln(e,t,n,o,r={},a=!1){t||(t={});for(const i in r)if(!(i in t)){if(i==="children")continue;r[i]=Be(e,i,null,r[i],n,a,t)}for(const i in t){if(i==="children")continue;const s=t[i];r[i]=Be(e,i,s,r[i],n,a,t)}}function cn(e){return e.toLowerCase().replace(/-([a-z])/g,(t,n)=>n.toUpperCase())}function qe(e,t,n){const o=t.trim().split(/\s+/);for(let r=0,a=o.length;r<a;r++)e.classList.toggle(o[r],n)}function Be(e,t,n,o,r,a,i){let s,l,c,p,d;if(t==="style")return lt(e,n,o);if(t==="classList")return sn(e,n,o);if(n===o)return o;if(t==="ref")a||n(e);else if(t.slice(0,3)==="on:"){const m=t.slice(3);o&&e.removeEventListener(m,o,typeof o!="function"&&o),n&&e.addEventListener(m,n,typeof n!="function"&&n)}else if(t.slice(0,10)==="oncapture:"){const m=t.slice(10);o&&e.removeEventListener(m,o,!0),n&&e.addEventListener(m,n,!0)}else if(t.slice(0,2)==="on"){const m=t.slice(2).toLowerCase(),h=zt.has(m);if(!h&&o){const v=Array.isArray(o)?o[0]:o;e.removeEventListener(m,v)}(h||n)&&(on(e,m,n,h),h&&re([m]))}else if(t.slice(0,5)==="attr:")Z(e,t.slice(5),n);else if(t.slice(0,5)==="bool:")nn(e,t.slice(5),n);else if((d=t.slice(0,5)==="prop:")||(c=Xt.has(t))||!r&&((p=Yt(t,e.tagName))||(l=Qt.has(t)))||(s=e.nodeName.includes("-")||"is"in i))d&&(t=t.slice(5),l=!0),t==="class"||t==="className"?rn(e,n):s&&!l&&!c?e[cn(t)]=n:e[p||t]=n;else{const m=r&&t.indexOf(":")>-1&&Jt[t.split(":")[0]];m?tn(e,m,t,n):Z(e,Kt[t]||t,n)}return n}function pn(e){let t=e.target;const n=`$$${e.type}`,o=e.target,r=e.currentTarget,a=l=>Object.defineProperty(e,"target",{configurable:!0,value:l}),i=()=>{const l=t[n];if(l&&!t.disabled){const c=t[`${n}Data`];if(c!==void 0?l.call(t,c,e):l.call(t,e),e.cancelBubble)return}return t.host&&typeof t.host!="string"&&!t.host._$host&&t.contains(e.target)&&a(t.host),!0},s=()=>{for(;i()&&(t=t._$host||t.parentNode||t.host););};if(Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return t||document}}),e.composedPath){const l=e.composedPath();a(l[0]);for(let c=0;c<l.length-2&&(t=l[c],!!i());c++){if(t._$host){t=t._$host,s();break}if(t.parentNode===r)break}}else s();a(o)}function ee(e,t,n,o,r){for(;typeof n=="function";)n=n();if(t===n)return n;const a=typeof t,i=o!==void 0;if(e=i&&n[0]&&n[0].parentNode||e,a==="string"||a==="number"){if(a==="number"&&(t=t.toString(),t===n))return n;if(i){let s=n[0];s&&s.nodeType===3?s.data!==t&&(s.data=t):s=document.createTextNode(t),n=X(e,n,o,s)}else n!==""&&typeof n=="string"?n=e.firstChild.data=t:n=e.textContent=t}else if(t==null||a==="boolean")n=X(e,n,o);else{if(a==="function")return N(()=>{let s=t();for(;typeof s=="function";)s=s();n=ee(e,s,n,o)}),()=>n;if(Array.isArray(t)){const s=[],l=n&&Array.isArray(n);if(Ie(s,t,n,r))return N(()=>n=ee(e,s,n,o,!0)),()=>n;if(s.length===0){if(n=X(e,n,o),i)return n}else l?n.length===0?Qe(e,s,o):Zt(e,n,s):(n&&X(e),Qe(e,s));n=s}else if(t.nodeType){if(Array.isArray(n)){if(i)return n=X(e,n,o,t);X(e,n,null,t)}else n==null||n===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);n=t}}return n}function Ie(e,t,n,o){let r=!1;for(let a=0,i=t.length;a<i;a++){let s=t[a],l=n&&n[e.length],c;if(!(s==null||s===!0||s===!1))if((c=typeof s)=="object"&&s.nodeType)e.push(s);else if(Array.isArray(s))r=Ie(e,s,l)||r;else if(c==="function")if(o){for(;typeof s=="function";)s=s();r=Ie(e,Array.isArray(s)?s:[s],Array.isArray(l)?l:[l])||r}else e.push(s),r=!0;else{const p=String(s);l&&l.nodeType===3&&l.data===p?e.push(l):e.push(document.createTextNode(p))}}return r}function Qe(e,t,n=null){for(let o=0,r=t.length;o<r;o++)e.insertBefore(t[o],n)}function X(e,t,n,o){if(n===void 0)return e.textContent="";const r=o||document.createTextNode("");if(t.length){let a=!1;for(let i=t.length-1;i>=0;i--){const s=t[i];if(r!==s){const l=s.parentNode===e;!a&&!i?l?e.replaceChild(r,s):e.insertBefore(r,n):l&&s.remove()}else a=!0}}else e.insertBefore(r,n);return[r]}const dn=!1;function ct(){let e=new Set;function t(r){return e.add(r),()=>e.delete(r)}let n=!1;function o(r,a){if(n)return!(n=!1);const i={to:r,options:a,defaultPrevented:!1,preventDefault:()=>i.defaultPrevented=!0};for(const s of e)s.listener({...i,from:s.location,retry:l=>{l&&(n=!0),s.navigate(r,{...a,resolve:!1})}});return!i.defaultPrevented}return{subscribe:t,confirm:o}}let Ee;function Le(){(!window.history.state||window.history.state._depth==null)&&window.history.replaceState({...window.history.state,_depth:window.history.length-1},""),Ee=window.history.state._depth}Le();function un(e){return{...e,_depth:window.history.state&&window.history.state._depth}}function mn(e,t){let n=!1;return()=>{const o=Ee;Le();const r=o==null?null:Ee-o;if(n){n=!1;return}r&&t(r)?(n=!0,window.history.go(-r)):e()}}const hn=/^(?:[a-z0-9]+:)?\/\//i,fn=/^\/+|(\/)\/+$/g,pt="http://sr";function B(e,t=!1){const n=e.replace(fn,"$1");return n?t||/^[?#]/.test(n)?n:"/"+n:""}function ce(e,t,n){if(hn.test(t))return;const o=B(e),r=n&&B(n);let a="";return!r||t.startsWith("/")?a=o:r.toLowerCase().indexOf(o.toLowerCase())!==0?a=o+r:a=r,(a||"/")+B(t,!a)}function gn(e,t){if(e==null)throw new Error(t);return e}function wn(e,t){return B(e).replace(/\/*(\*.*)?$/g,"")+B(t)}function dt(e){const t={};return e.searchParams.forEach((n,o)=>{o in t?Array.isArray(t[o])?t[o].push(n):t[o]=[t[o],n]:t[o]=n}),t}function bn(e,t,n){const[o,r]=e.split("/*",2),a=o.split("/").filter(Boolean),i=a.length;return s=>{const l=s.split("/").filter(Boolean),c=l.length-i;if(c<0||c>0&&r===void 0&&!t)return null;const p={path:i?"":"/",params:{}},d=m=>n===void 0?void 0:n[m];for(let m=0;m<i;m++){const h=a[m],v=h[0]===":",f=v?l[m]:l[m].toLowerCase(),b=v?h.slice(1):h.toLowerCase();if(v&&Ce(f,d(b)))p.params[b]=f;else if(v||!Ce(f,b))return null;p.path+=`/${f}`}if(r){const m=c?l.slice(-c).join("/"):"";if(Ce(m,d(r)))p.params[r]=m;else return null}return p}}function Ce(e,t){const n=o=>o===e;return t===void 0?!0:typeof t=="string"?n(t):typeof t=="function"?t(e):Array.isArray(t)?t.some(n):t instanceof RegExp?t.test(e):!1}function vn(e){const[t,n]=e.pattern.split("/*",2),o=t.split("/").filter(Boolean);return o.reduce((r,a)=>r+(a.startsWith(":")?2:3),o.length-(n===void 0?0:1))}function ut(e){const t=new Map,n=tt();return new Proxy({},{get(o,r){return t.has(r)||nt(n,()=>t.set(r,k(()=>e()[r]))),t.get(r)()},getOwnPropertyDescriptor(){return{enumerable:!0,configurable:!0}},ownKeys(){return Reflect.ownKeys(e())}})}function mt(e){let t=/(\/?\:[^\/]+)\?/.exec(e);if(!t)return[e];let n=e.slice(0,t.index),o=e.slice(t.index+t[0].length);const r=[n,n+=t[1]];for(;t=/^(\/\:[^\/]+)\?/.exec(o);)r.push(n+=t[1]),o=o.slice(t[0].length);return mt(o).reduce((a,i)=>[...a,...r.map(s=>s+i)],[])}const yn=100,ht=ge(),Re=ge(),we=()=>gn(te(ht),"<A> and 'use' router primitives can be only used inside a Route."),_n=()=>te(Re)||we().base,xn=e=>{const t=_n();return k(()=>t.resolvePath(e()))},Sn=e=>{const t=we();return k(()=>{const n=e();return n!==void 0?t.renderPath(n):n})},ft=()=>we().navigatorFactory(),Cn=()=>we().location;function Pn(e,t=""){const{component:n,preload:o,load:r,children:a,info:i}=e,s=!a||Array.isArray(a)&&!a.length,l={key:e,component:n,preload:o||r,info:i};return gt(e.path).reduce((c,p)=>{for(const d of mt(p)){const m=wn(t,d);let h=s?m:m.split("/*",1)[0];h=h.split("/").map(v=>v.startsWith(":")||v.startsWith("*")?v:encodeURIComponent(v)).join("/"),c.push({...l,originalPath:p,pattern:h,matcher:bn(h,!s,e.matchFilters)})}return c},[])}function On(e,t=0){return{routes:e,score:vn(e[e.length-1])*1e4-t,matcher(n){const o=[];for(let r=e.length-1;r>=0;r--){const a=e[r],i=a.matcher(n);if(!i)return null;o.unshift({...i,route:a})}return o}}}function gt(e){return Array.isArray(e)?e:[e]}function wt(e,t="",n=[],o=[]){const r=gt(e);for(let a=0,i=r.length;a<i;a++){const s=r[a];if(s&&typeof s=="object"){s.hasOwnProperty("path")||(s.path="");const l=Pn(s,t);for(const c of l){n.push(c);const p=Array.isArray(s.children)&&s.children.length===0;if(s.children&&!p)wt(s.children,c.pattern,n,o);else{const d=On([...n],o.length);o.push(d)}n.pop()}}}return n.length?o:o.sort((a,i)=>i.score-a.score)}function Pe(e,t){for(let n=0,o=e.length;n<o;n++){const r=e[n].matcher(t);if(r)return r}return[]}function An(e,t,n){const o=new URL(pt),r=k(p=>{const d=e();try{return new URL(d,o)}catch{return console.error(`Invalid path ${d}`),p}},o,{equals:(p,d)=>p.href===d.href}),a=k(()=>r().pathname),i=k(()=>r().search,!0),s=k(()=>r().hash),l=()=>"",c=Te(i,()=>dt(r()));return{get pathname(){return a()},get search(){return i()},get hash(){return s()},get state(){return t()},get key(){return l()},query:n?n(c):ut(c)}}let q;function $n(){return q}function kn(e,t,n,o={}){const{signal:[r,a],utils:i={}}=e,s=i.parsePath||(S=>S),l=i.renderPath||(S=>S),c=i.beforeLeave||ct(),p=ce("",o.base||"");if(p===void 0)throw new Error(`${p} is not a valid base path`);p&&!r().value&&a({value:p,replace:!0,scroll:!1});const[d,m]=T(!1);let h;const v=(S,P)=>{P.value===f()&&P.state===_()||(h===void 0&&m(!0),q=S,h=P,Tt(()=>{h===P&&(b(h.value),y(h.state),E[1]([]))}).finally(()=>{h===P&&Et(()=>{q=void 0,S==="navigate"&&Ct(h),m(!1),h=void 0})}))},[f,b]=T(r().value),[_,y]=T(r().state),O=An(f,_,i.queryWrapper),A=[],E=T([]),W=k(()=>typeof o.transformUrl=="function"?Pe(t(),o.transformUrl(O.pathname)):Pe(t(),O.pathname)),He=()=>{const S=W(),P={};for(let M=0;M<S.length;M++)Object.assign(P,S[M].params);return P},_t=i.paramsWrapper?i.paramsWrapper(He,t):ut(He),Ue={pattern:p,path:()=>p,outlet:()=>null,resolvePath(S){return ce(p,S)}};return N(Te(r,S=>v("native",S),{defer:!0})),{base:Ue,location:O,params:_t,isRouting:d,renderPath:l,parsePath:s,navigatorFactory:St,matches:W,beforeLeave:c,preloadRoute:Pt,singleFlight:o.singleFlight===void 0?!0:o.singleFlight,submissions:E};function xt(S,P,M){R(()=>{if(typeof P=="number"){P&&(i.go?i.go(P):console.warn("Router integration does not support relative routing"));return}const ae=!P||P[0]==="?",{replace:ve,resolve:Q,scroll:ye,state:K}={replace:!1,resolve:!ae,scroll:!0,...M},ie=Q?S.resolvePath(P):ce(ae&&O.pathname||"",P);if(ie===void 0)throw new Error(`Path '${P}' is not a routable path`);if(A.length>=yn)throw new Error("Too many redirects");const je=f();(ie!==je||K!==_())&&(dn||c.confirm(ie,M)&&(A.push({value:je,replace:ve,scroll:ye,state:_()}),v("navigate",{value:ie,state:K})))})}function St(S){return S=S||te(Re)||Ue,(P,M)=>xt(S,P,M)}function Ct(S){const P=A[0];P&&(a({...S,replace:P.replace,scroll:P.scroll}),A.length=0)}function Pt(S,P){const M=Pe(t(),S.pathname),ae=q;q="preload";for(let ve in M){const{route:Q,params:ye}=M[ve];Q.component&&Q.component.preload&&Q.component.preload();const{preload:K}=Q;P&&K&&nt(n(),()=>K({params:ye,location:{pathname:S.pathname,search:S.search,hash:S.hash,query:dt(S),state:null,key:""},intent:"preload"}))}q=ae}}function In(e,t,n,o){const{base:r,location:a,params:i}=e,{pattern:s,component:l,preload:c}=o().route,p=k(()=>o().path);l&&l.preload&&l.preload();const d=c?c({params:i,location:a,intent:q||"initial"}):void 0;return{parent:t,pattern:s,path:p,outlet:()=>l?u(l,{params:i,location:a,data:d,get children(){return n()}}):n(),resolvePath(h){return ce(r.path(),h,p())}}}const En=e=>t=>{const{base:n}=t,o=Ne(()=>t.children),r=k(()=>wt(o(),t.base||""));let a;const i=kn(e,r,()=>a,{base:n,singleFlight:t.singleFlight,transformUrl:t.transformUrl});return e.create&&e.create(i),u(ht.Provider,{value:i,get children(){return u(Tn,{routerState:i,get root(){return t.root},get preload(){return t.rootPreload||t.rootLoad},get children(){return[z(()=>(a=tt())&&null),u(Nn,{routerState:i,get branches(){return r()}})]}})}})};function Tn(e){const t=e.routerState.location,n=e.routerState.params,o=k(()=>e.preload&&R(()=>{e.preload({params:n,location:t,intent:$n()||"initial"})}));return u(it,{get when(){return e.root},keyed:!0,get fallback(){return e.children},children:r=>u(r,{params:n,location:t,get data(){return o()},get children(){return e.children}})})}function Nn(e){const t=[];let n;const o=k(Te(e.routerState.matches,(r,a,i)=>{let s=a&&r.length===a.length;const l=[];for(let c=0,p=r.length;c<p;c++){const d=a&&a[c],m=r[c];i&&d&&m.route.key===d.route.key?l[c]=i[c]:(s=!1,t[c]&&t[c](),Y(h=>{t[c]=h,l[c]=In(e.routerState,l[c-1]||e.routerState.base,Xe(()=>o()[c+1]),()=>e.routerState.matches()[c])}))}return t.splice(r.length).forEach(c=>c()),i&&s?i:(n=l[0],l)}));return Xe(()=>o()&&n)()}const Xe=e=>()=>u(it,{get when(){return e()},keyed:!0,children:t=>u(Re.Provider,{value:t,get children(){return t.outlet()}})}),F=e=>{const t=Ne(()=>e.children);return $e(e,{get children(){return t()}})};function Dn([e,t],n,o){return[e,o?r=>t(o(r)):t]}function Fn(e){let t=!1;const n=r=>typeof r=="string"?{value:r}:r,o=Dn(T(n(e.get()),{equals:(r,a)=>r.value===a.value&&r.state===a.state}),void 0,r=>(!t&&e.set(r),r));return e.init&&j(e.init((r=e.get())=>{t=!0,o[1](n(r)),t=!1})),En({signal:o,create:e.create,utils:e.utils})}function Ln(e,t,n){return e.addEventListener(t,n),()=>e.removeEventListener(t,n)}function Rn(e,t){const n=e&&document.getElementById(e);n?n.scrollIntoView():t&&window.scrollTo(0,0)}const Mn=new Map;function Hn(e=!0,t=!1,n="/_server",o){return r=>{const a=r.base.path(),i=r.navigatorFactory(r.base);let s,l;function c(f){return f.namespaceURI==="http://www.w3.org/2000/svg"}function p(f){if(f.defaultPrevented||f.button!==0||f.metaKey||f.altKey||f.ctrlKey||f.shiftKey)return;const b=f.composedPath().find(W=>W instanceof Node&&W.nodeName.toUpperCase()==="A");if(!b||t&&!b.hasAttribute("link"))return;const _=c(b),y=_?b.href.baseVal:b.href;if((_?b.target.baseVal:b.target)||!y&&!b.hasAttribute("state"))return;const A=(b.getAttribute("rel")||"").split(/\s+/);if(b.hasAttribute("download")||A&&A.includes("external"))return;const E=_?new URL(y,document.baseURI):new URL(y);if(!(E.origin!==window.location.origin||a&&E.pathname&&!E.pathname.toLowerCase().startsWith(a.toLowerCase())))return[b,E]}function d(f){const b=p(f);if(!b)return;const[_,y]=b,O=r.parsePath(y.pathname+y.search+y.hash),A=_.getAttribute("state");f.preventDefault(),i(O,{resolve:!1,replace:_.hasAttribute("replace"),scroll:!_.hasAttribute("noscroll"),state:A?JSON.parse(A):void 0})}function m(f){const b=p(f);if(!b)return;const[_,y]=b;r.preloadRoute(y,_.getAttribute("preload")!=="false")}function h(f){clearTimeout(s);const b=p(f);if(!b)return l=null;const[_,y]=b;l!==_&&(s=setTimeout(()=>{r.preloadRoute(y,_.getAttribute("preload")!=="false"),l=_},20))}function v(f){if(f.defaultPrevented)return;let b=f.submitter&&f.submitter.hasAttribute("formaction")?f.submitter.getAttribute("formaction"):f.target.getAttribute("action");if(!b)return;if(!b.startsWith("https://action/")){const y=new URL(b,pt);if(b=r.parsePath(y.pathname+y.search),!b.startsWith(n))return}if(f.target.method.toUpperCase()!=="POST")throw new Error("Only POST forms are supported for Actions");const _=Mn.get(b);if(_){f.preventDefault();const y=new FormData(f.target,f.submitter);_.call({r,f:f.target},f.target.enctype==="multipart/form-data"?y:new URLSearchParams(y))}}re(["click","submit"]),document.addEventListener("click",d),e&&(document.addEventListener("mousemove",h,{passive:!0}),document.addEventListener("focusin",m,{passive:!0}),document.addEventListener("touchstart",m,{passive:!0})),document.addEventListener("submit",v),j(()=>{document.removeEventListener("click",d),e&&(document.removeEventListener("mousemove",h),document.removeEventListener("focusin",m),document.removeEventListener("touchstart",m)),document.removeEventListener("submit",v)})}}function Un(e){const t=e.replace(/^.*?#/,"");if(!t.startsWith("/")){const[,n="/"]=window.location.hash.split("#",2);return`${n}#${t}`}return t}function jn(e){const t=()=>window.location.hash.slice(1),n=ct();return Fn({get:t,set({value:o,replace:r,scroll:a,state:i}){r?window.history.replaceState(un(i),"","#"+o):window.history.pushState(i,"","#"+o);const s=o.indexOf("#"),l=s>=0?o.slice(s+1):"";Rn(l,a),Le()},init:o=>Ln(window,"hashchange",mn(o,r=>!n.confirm(r&&r<0?r:t()))),create:Hn(e.preload,e.explicitLinks,e.actionBase),utils:{go:o=>window.history.go(o),renderPath:o=>`#${o}`,parsePath:Un,beforeLeave:n}})(e)}var Gn=w("<a>");function $(e){e=$e({inactiveClass:"inactive",activeClass:"active"},e);const[,t]=jt(e,["href","state","class","activeClass","inactiveClass","end"]),n=xn(()=>e.href),o=Sn(n),r=Cn(),a=k(()=>{const i=n();if(i===void 0)return[!1,!1];const s=B(i.split(/[?#]/,1)[0]).toLowerCase(),l=decodeURI(B(r.pathname).toLowerCase());return[e.end?s===l:l.startsWith(s+"/")||l===s,s===l]});return(()=>{var i=Gn();return ke(i,$e(t,{get href(){return o()||e.href},get state(){return JSON.stringify(e.state)},get classList(){return{...e.class&&{[e.class]:!0},[e.inactiveClass]:!a()[0],[e.activeClass]:a()[0],...t.classList}},link:"",get"aria-current"(){return a()[1]?"page":void 0}}),!1,!1),i})()}const bt=ge(),Wn=["title","meta"],Ke=[],Ve=["name","http-equiv","content","charset","media"].concat(["property"]),Ye=(e,t)=>{const n=Object.fromEntries(Object.entries(e.props).filter(([o])=>t.includes(o)).sort());return(Object.hasOwn(n,"name")||Object.hasOwn(n,"property"))&&(n.name=n.name||n.property,delete n.property),e.tag+JSON.stringify(n)};function qn(){{const n=document.head.querySelectorAll("[data-sm]");Array.prototype.forEach.call(n,o=>o.parentNode.removeChild(o))}const e=new Map;function t(n){if(n.ref)return n.ref;let o=document.querySelector(`[data-sm="${n.id}"]`);return o?(o.tagName.toLowerCase()!==n.tag&&(o.parentNode&&o.parentNode.removeChild(o),o=document.createElement(n.tag)),o.removeAttribute("data-sm")):o=document.createElement(n.tag),o}return{addTag(n){if(Wn.indexOf(n.tag)!==-1){const a=n.tag==="title"?Ke:Ve,i=Ye(n,a);e.has(i)||e.set(i,[]);let s=e.get(i),l=s.length;s=[...s,n],e.set(i,s);let c=t(n);n.ref=c,ke(c,n.props);let p=null;for(var o=l-1;o>=0;o--)if(s[o]!=null){p=s[o];break}return c.parentNode!=document.head&&document.head.appendChild(c),p&&p.ref&&p.ref.parentNode&&document.head.removeChild(p.ref),l}let r=t(n);return n.ref=r,ke(r,n.props),r.parentNode!=document.head&&document.head.appendChild(r),-1},removeTag(n,o){const r=n.tag==="title"?Ke:Ve,a=Ye(n,r);if(n.ref){const i=e.get(a);if(i){if(n.ref.parentNode){n.ref.parentNode.removeChild(n.ref);for(let s=o-1;s>=0;s--)i[s]!=null&&document.head.appendChild(i[s].ref)}i[o]=null,e.set(a,i)}else n.ref.parentNode&&n.ref.parentNode.removeChild(n.ref)}}}}const Bn=e=>{const t=qn();return u(bt.Provider,{value:t,get children(){return e.children}})},vt=(e,t,n)=>(Qn({tag:e,props:t,setting:n,id:Wt(),get name(){return t.name||t.property}}),null);function Qn(e){const t=te(bt);if(!t)throw new Error("<MetaProvider /> should be in the tree");N(()=>{const n=t.addTag(e);j(()=>t.removeTag(e,n))})}const L=e=>vt("title",e,{escape:!0,close:!0}),V=e=>vt("meta",e),Xn="4bc8c4f28c625fca2004a5f486c31aa4f161dc9f3c0c6b2c9237db12f55ac442",Kn="ba5f920b7136c1cd3101518a952c085a4e2313e4800d628c86b630f142808039";async function ze(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return Array.from(new Uint8Array(t)).map(n=>n.toString(16).padStart(2,"0")).join("")}const yt=ge();function Vn(e){const[t,n]=T(localStorage.getItem("auth_logged_in")==="true"),[o,r]=T(localStorage.getItem("auth_username")||""),a=async(s,l)=>{const c=await ze(s),p=await ze(l);return c===Xn&&p===Kn?(localStorage.setItem("auth_logged_in","true"),localStorage.setItem("auth_username",s),n(!0),r(s),!0):!1},i=()=>{localStorage.removeItem("auth_logged_in"),localStorage.removeItem("auth_username"),n(!1),r("")};return u(yt.Provider,{value:{isLoggedIn:t,username:o,login:a,logout:i},get children(){return e.children}})}function Me(){const e=te(yt);if(!e)throw new Error("useAuth must be used within AuthProvider");return e}var Yn=w("<nav id=navbar><ul class=nav-links><li></li><li></li><li></li><li></li><li>"),zn=w("<span class=logged-in-text style=cursor:pointer;color:#00d4ff;font-weight:bold;font-size:0.9rem>已登录"),Jn=w("<div class=dialog-overlay>"),Zn=w('<div class=dialog-box><p style="margin:0 0 6px;font-size:1rem">当前用户：<strong></strong></p><p style="margin:0 0 20px;color:#888;font-size:0.85rem">确定要退出登录吗？退出后需重新输入密码访问项目链接。</p><div style=display:flex;gap:10px;justify-content:flex-end><button style="padding:8px 20px;background:#333;color:#fff;border:none;border-radius:6px;cursor:pointer">取消</button><button style="padding:8px 20px;background:#d33;color:#fff;border:none;border-radius:6px;cursor:pointer">退出登录');function er(){let e;const{isLoggedIn:t,username:n,logout:o}=Me(),[r,a]=T(!1);D(()=>{let s=window.scrollY;const l=()=>{const c=Math.max(0,window.scrollY);c>s&&c>100?e.classList.add("hidden"):e.classList.remove("hidden"),s=c};window.addEventListener("scroll",l),j(()=>window.removeEventListener("scroll",l))});const i=()=>{o(),a(!1)};return[(()=>{var s=Yn(),l=s.firstChild,c=l.firstChild,p=c.nextSibling,d=p.nextSibling,m=d.nextSibling,h=m.nextSibling,v=e;return typeof v=="function"?oe(v,s):e=s,g(s,u($,{href:"/",class:"logo",style:"text-decoration:none;",children:"DeltrivX"}),l),g(c,u($,{href:"/about",children:"关于"})),g(p,u($,{href:"/skills",children:"技能"})),g(d,u($,{href:"/projects",children:"项目"})),g(m,u($,{href:"/articles",children:"实战"})),g(h,(()=>{var f=z(()=>!!t());return()=>f()?(()=>{var b=zn();return b.$$click=()=>a(!0),b})():u($,{href:"/login",style:"color:#007bff;font-weight:bold;",children:"登录"})})()),s})(),z(()=>z(()=>!!r())()&&[(()=>{var s=Jn();return s.$$click=()=>a(!1),s})(),(()=>{var s=Zn(),l=s.firstChild,c=l.firstChild,p=c.nextSibling,d=l.nextSibling,m=d.nextSibling,h=m.firstChild,v=h.nextSibling;return g(p,n),h.$$click=()=>a(!1),v.$$click=i,s})()])]}re(["click"]);var tr=w("<footer><p>© <!> DeltrivX. Made with ❤️ and lots of ☕");function nr(){const e=new Date().getFullYear();return(()=>{var t=tr(),n=t.firstChild,o=n.firstChild,r=o.nextSibling;return r.nextSibling,g(n,e,r),t})()}var rr=w("<canvas id=particles>");function or(){let e,t;return D(()=>{const n=e.getContext("2d");let o=[],r={x:null,y:null};const a=()=>{e.width=window.innerWidth,e.height=window.innerHeight};a(),window.addEventListener("resize",a);const i=p=>{r.x=p.clientX,r.y=p.clientY};document.addEventListener("mousemove",i);class s{constructor(){this.reset()}reset(){this.x=Math.random()*e.width,this.y=Math.random()*e.height,this.size=Math.random()*2+.5,this.speedX=(Math.random()-.5)*.5,this.speedY=(Math.random()-.5)*.5,this.opacity=Math.random()*.5+.1}update(){if(this.x+=this.speedX,this.y+=this.speedY,r.x!==null){const d=r.x-this.x,m=r.y-this.y,h=Math.sqrt(d*d+m*m);if(h<120){const v=(120-h)/120;this.x-=d/h*v*1.5,this.y-=m/h*v*1.5}}(this.x<0||this.x>e.width||this.y<0||this.y>e.height)&&this.reset()}draw(){n.beginPath(),n.arc(this.x,this.y,this.size,0,Math.PI*2),n.fillStyle=`rgba(108, 92, 231, ${this.opacity})`,n.fill()}}const l=Math.min(120,Math.floor(e.width*e.height/12e3));for(let p=0;p<l;p++)o.push(new s);function c(){n.clearRect(0,0,e.width,e.height),o.forEach(p=>{p.update(),p.draw()}),t=requestAnimationFrame(c)}c(),j(()=>{window.removeEventListener("resize",a),document.removeEventListener("mousemove",i),cancelAnimationFrame(t)})}),(()=>{var n=rr(),o=e;return typeof o=="function"?oe(o,n):e=n,n})()}var sr=w("<div class=spotlight>"),ar=w("<main>");function ir(e){let t;return D(()=>{const n=o=>{document.documentElement.style.setProperty("--mouse-x",`${o.clientX}px`),document.documentElement.style.setProperty("--mouse-y",`${o.clientY}px`)};window.addEventListener("mousemove",n),j(()=>window.removeEventListener("mousemove",n))}),[(()=>{var n=sr(),o=t;return typeof o=="function"?oe(o,n):t=n,n})(),u(or,{}),u(er,{}),(()=>{var n=ar();return g(n,()=>e.children),n})(),u(nr,{})]}function se(){const e=document.querySelectorAll(".reveal"),t=new IntersectionObserver(n=>{n.forEach((o,r)=>{o.isIntersecting&&setTimeout(()=>o.target.classList.add("visible"),r*100)})},{threshold:.15});e.forEach(n=>t.observe(n))}function be(){document.querySelectorAll(".tilt-card").forEach(t=>{const n=t.querySelector(".tilt-card-inner")||t;t.addEventListener("mousemove",o=>{const r=t.getBoundingClientRect(),a=o.clientX-r.left,i=o.clientY-r.top,s=r.width/2,l=r.height/2,c=(i-l)/l*-10,p=(a-s)/s*10;n.style.transform=`rotateX(${c}deg) rotateY(${p}deg) scale(1.02)`}),t.addEventListener("mouseleave",()=>{n.style.transform="rotateX(0) rotateY(0) scale(1)"})})}var lr=w("<section class=hero><div class=hero-content><span class=hero-badge>👋 欢迎来到我的个人主页</span><h1>Hi, I'm <span class=gradient-text>DeltrivX</span></h1><div class=typewriter></div><div class=hero-buttons></div></div><div class=scroll-indicator><span>"),cr=w("<div class=nav-card-icon>👨‍💻"),pr=w("<h3>关于我"),dr=w("<p>了解我的背景和经历"),ur=w("<div class=nav-card-icon>⚡"),mr=w("<h3>技能栈"),hr=w("<p>掌握的技术与工具"),fr=w("<div class=nav-card-icon>🚀"),gr=w("<h3>精选项目"),wr=w("<p>查看我的作品展示"),br=w("<div class=nav-card-icon>📝"),vr=w("<h3>实战"),yr=w("<p>查看我的技术实战"),_r=w('<section class=explore-section><div class="section-header reveal"><h2><span class=gradient-text>探索更多</span></h2><p>了解我的技能、项目和联系方式</p></div><div class=nav-cards-grid>');function xr(){let e,t;return D(()=>{se(),be();const n=["全栈开发者 🚀","UI/UX 设计爱好者 🎨","开源贡献者 💡","终身学习者 📚","AI 探索者 🤖"];let o=0,r=0,a=!1;function i(){const s=n[o];a?(e.innerHTML=s.substring(0,r-1)+'<span class="cursor"></span>',r--):(e.innerHTML=s.substring(0,r+1)+'<span class="cursor"></span>',r++);let l=a?40:80;!a&&r===s.length?(l=2e3,a=!0):a&&r===0&&(a=!1,o=(o+1)%n.length,l=500),t=setTimeout(i,l)}i()}),j(()=>clearTimeout(t)),[(()=>{var n=lr(),o=n.firstChild,r=o.firstChild,a=r.nextSibling,i=a.nextSibling,s=i.nextSibling,l=e;return typeof l=="function"?oe(l,i):e=i,g(s,u($,{href:"/projects",class:"btn btn-primary",children:"🚀 查看项目"}),null),g(s,u($,{href:"/about",class:"btn btn-outline",children:"💬 联系我"}),null),n})(),(()=>{var n=_r(),o=n.firstChild,r=o.nextSibling;return g(r,u($,{href:"/about",class:"nav-card reveal tilt-card",get children(){return[cr(),pr(),dr()]}}),null),g(r,u($,{href:"/skills",class:"nav-card reveal tilt-card",get children(){return[ur(),mr(),hr()]}}),null),g(r,u($,{href:"/projects",class:"nav-card reveal tilt-card",get children(){return[fr(),gr(),wr()]}}),null),g(r,u($,{href:"/articles",class:"nav-card reveal tilt-card",get children(){return[br(),vr(),yr()]}}),null),n})()]}var Sr=w('<section id=about><div class=about-grid><div class="about-image-wrapper reveal"><div class=about-image>🖥️</div></div><div class="about-text reveal"><h3>AI 折腾党 & 自建派</h3><p>我是 DeltrivX，一名热爱自建（self-hosting）的技术爱好者。从一台 FnOS 起步，逐步搭建起覆盖存储、影音、下载、AI 的家庭数据中心。</p><p>热衷于用 Docker 容器编排各类服务，打通 Cloudflare Tunnel 公网访问，构建属于自己的数字基础设施。同时也在探索 LLM 应用与 AIGC 的可能性。</p><div class=stats-row><div class=stat-item><div class=stat-number data-target=27>0</div><div class=stat-label>Docker 容器</div></div><div class=stat-item><div class=stat-number data-target=20>0</div><div class=stat-label>自建服务</div></div><div class=stat-item><div class=stat-number data-target=9>0</div><div class=stat-label>GitHub 仓库</div></div></div></div></div><div class="contact-wrapper reveal"><div class=contact-info><h3>保持联系 🤝</h3><p>无论是项目合作、技术交流还是随便聊聊，都欢迎联系我。</p><div class=contact-links><a href=mailto:deltrivx@icloud.com class=contact-link-item><span class=contact-link-icon>📧</span><div class=contact-link-text><strong>Email</strong><span>deltrivx@icloud.com</span></div></a><a href=https://github.com/deltrivx target=_blank rel=noopener class=contact-link-item><span class=contact-link-icon>🐙</span><div class=contact-link-text><strong>GitHub</strong><span>DeltrivX</span></div></a><a href=https://x.com/deltrivx target=_blank rel=noopener class=contact-link-item><span class=contact-link-icon>🐦</span><div class=contact-link-text><strong>Twitter（X）</strong><span>@deltrivx</span></div></a></div></div><form class=contact-form action=https://formspree.io/f/placeholder><div class=form-group><input type=text name=name placeholder=你的名字 required></div><div class=form-group><input type=email name=email placeholder=你的邮箱 required></div><div class=form-group><textarea name=message placeholder=你想说什么... required></textarea></div><button type=submit class="btn btn-primary">');function Cr(){const[e,t]=T({text:"🚀 发送消息",bg:""});let n=!1;D(()=>{se();const r=document.querySelectorAll(".stat-number"),a=new IntersectionObserver(i=>{i.forEach(s=>{if(s.isIntersecting){const l=s.target,c=parseInt(l.dataset.target);let p=0;const d=Math.max(1,Math.floor(c/60)),m=setInterval(()=>{p+=d,p>=c&&(p=c,clearInterval(m)),l.textContent=p.toLocaleString()+"+"},30);a.unobserve(l)}})},{threshold:.5});r.forEach(i=>a.observe(i))});const o=async r=>{if(r.preventDefault(),n)return;n=!0;const a=r.target;t({text:"⏳ 发送中...",bg:""});try{if((await fetch(a.action,{method:"POST",body:new FormData(a),headers:{Accept:"application/json"}})).ok)t({text:"✅ 已发送！",bg:"linear-gradient(135deg, #00b894, #00cec9)"}),a.reset();else throw new Error("发送失败")}catch{t({text:"❌ 发送失败，请直接邮件联系",bg:"linear-gradient(135deg, #d63031, #e17055)"})}setTimeout(()=>{n=!1,t({text:"🚀 发送消息",bg:""})},3e3)};return(()=>{var r=Sr(),a=r.firstChild,i=a.nextSibling,s=i.firstChild,l=s.nextSibling,c=l.firstChild,p=c.nextSibling,d=p.nextSibling,m=d.nextSibling;return l.addEventListener("submit",o),m.disabled=n,g(m,()=>e().text),N(h=>lt(m,`width:100%;justify-content:center;background:${e().bg}`,h)),r})()}const Pr=[{icon:"🎨",title:"前端开发",description:"构建响应式、交互丰富的现代 Web 应用",tags:[{name:"SolidJS",level:88},{name:"React",level:82},{name:"TypeScript",level:80},{name:"Vite",level:88},{name:"Tailwind CSS",level:75}]},{icon:"⚙️",title:"后端开发",description:"设计高可用、可扩展的服务端架构",tags:[{name:"Node.js",level:85},{name:"Python",level:75},{name:"PostgreSQL",level:70},{name:"REST API",level:82}]},{icon:"☁️",title:"DevOps & 云",description:"自动化部署，保障系统稳定运行",tags:[{name:"Docker",level:85},{name:"Cloudflare",level:80},{name:"Nginx",level:75},{name:"GitHub Actions",level:80},{name:"Linux",level:78}]},{icon:"🤖",title:"AI 应用",description:"大模型应用开发与智能代理系统",tags:[{name:"LLM",level:85},{name:"RAG",level:78},{name:"AI Agent",level:85},{name:"TTS",level:72},{name:"Prompt Engineering",level:80}]},{icon:"🎬",title:"影视媒体",description:"全流程影视资源管理与媒体服务搭建",tags:[{name:"Emby",level:80},{name:"MoviePilot",level:75},{name:"FFmpeg",level:65},{name:"Aria2",level:82},{name:"qBittorrent",level:82},{name:"Transmission",level:78}]},{icon:"🗄️",title:"数据与存储",description:"多类型数据存储方案与私有云基础设施",tags:[{name:"PostgreSQL",level:72},{name:"Redis",level:70},{name:"Kvrocks",level:65},{name:"NAS 私有云",level:75}]}];var Or=w('<section id=skills><div class="section-header reveal"><h2><span class=gradient-text>技能栈</span></h2><p>持续学习，不断突破技术边界</p></div><div class=skills-grid>'),Ar=w('<div class="skill-card reveal tilt-card"><div class=skill-icon></div><h3></h3><p></p><div class=skill-tags></div><div class=skill-bar-group>'),$r=w("<span class=skill-tag>"),kr=w("<div class=skill-bar-item><div class=skill-bar-header><span></span><span>%</span></div><div class=skill-bar-track><div class=skill-bar-fill style=width:0>");function Ir(){return D(()=>{se(),be();const e=new IntersectionObserver(t=>{t.forEach(n=>{n.isIntersecting&&(n.target.querySelectorAll(".skill-bar-fill").forEach((r,a)=>{const i=r.dataset.level;setTimeout(()=>{r.style.width=i+"%"},a*80)}),e.unobserve(n.target))})},{threshold:.3});setTimeout(()=>{document.querySelectorAll(".skill-bar-group").forEach(t=>e.observe(t))},100)}),(()=>{var e=Or(),t=e.firstChild,n=t.nextSibling;return g(n,u(Se,{each:Pr,children:o=>(()=>{var r=Ar(),a=r.firstChild,i=a.nextSibling,s=i.nextSibling,l=s.nextSibling,c=l.nextSibling;return g(a,()=>o.icon),g(i,()=>o.title),g(s,()=>o.description),g(l,u(Se,{get each(){return o.tags},children:p=>(()=>{var d=$r();return g(d,()=>p.name),d})()})),g(c,u(Se,{get each(){return o.tags},children:p=>(()=>{var d=kr(),m=d.firstChild,h=m.firstChild,v=h.nextSibling,f=v.firstChild,b=m.nextSibling,_=b.firstChild;return g(h,()=>p.name),g(v,()=>p.level,f),N(()=>Z(_,"data-level",p.level)),d})()})),r})()})),e})()}var Er=w('<a target=_blank rel="noopener noreferrer">');function Tr(e){const{isLoggedIn:t}=Me(),n=ft(),o=r=>{t()||(r.preventDefault(),n(`/login?redirect=${encodeURIComponent(e.href)}`))};return(()=>{var r=Er();return r.$$click=o,g(r,()=>e.label),N(()=>Z(r,"href",e.href)),r})()}re(["click"]);var Nr=w('<section id=projects><div class="section-header reveal"><h2><span class=gradient-text>精选项目</span></h2><p>一些我引以为豪的作品</p></div><div class=projects-grid>'),Dr=w('<div class="project-card reveal tilt-card"><div class=project-preview><div class=project-preview-bg style=fontSize:3rem;display:flex;alignItems:center;justifyContent:center;height:100%></div></div><div class=project-info><h3></h3><p></p><div class=project-tech></div><div class=project-links>'),Fr=w("<span class=tech-tag>");function Lr(){D(()=>{se(),be()});const e=[{icon:"🐮",name:"飞牛系统",desc:"FnOS 私有云系统，提供存储、影音、下载等一站式服务。",tech:["FnOS","NAS"],links:[{url:"https://fnos.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:5080",label:"🔗 内网"}]},{icon:"🏠",name:"HomeAssistant",desc:"智能家居控制系统，集成灯光、传感器、自动化场景等设备。",tech:["IoT","智能家居"],links:[{url:"https://homeassistant.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.3:8123",label:"🔗 内网"}]},{icon:"🎬",name:"飞牛影视",desc:"FnOS 内置影视中心，支持在线观影与媒体管理。",tech:["FnOS","影视"],links:[{url:"https://fntv.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:8005",label:"🔗 内网"}]},{icon:"🔗",name:"SubStore",desc:"订阅管理与转换工具，支持多协议节点聚合与规则处理。",tech:["订阅","代理","工具"],links:[{url:"https://substore.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:3100",label:"🔗 内网"}]},{icon:"🛜",name:"iStoreOS",desc:"软路由与家庭网络管理系统，承载双网接入、插件扩展与局域网服务。",tech:["iStoreOS","软路由","网络"],links:[{url:"https://istoreos.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.10:80",label:"🔗 内网"}]},{icon:"🌐",name:"Chromium",desc:"远程 Chromium 浏览器实例，支持自动化脚本和 Web 测试。",tech:["Chromium","浏览器"],links:[{url:"https://chromium.deltrivx.com",label:"🌐 公网"},{url:"https://192.168.31.2:3011",label:"🔗 内网"}]},{icon:"🎛️",name:"Emby 影音中心",desc:"全平台媒体管理与串流服务器，整合影视资源库。",tech:["Emby Server","NAS"],links:[{url:"https://emby.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:8096",label:"🔗 内网"}]},{icon:"🎯",name:"MoviePilot",desc:"自动化影视资源订阅与下载管理，辅以豆瓣榜单同步。",tech:["MoviePilot","自动化"],links:[{url:"https://moviepilot.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:3000",label:"🔗 内网"}]},{icon:"📡",name:"PanSou 搜盘引擎",desc:"网盘资源搜索引擎，聚合多方盘源。",tech:["搜索","网盘"],links:[{url:"https://pansou.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:3080",label:"🔗 内网"}]},{icon:"📥",name:"Telegram 下载器",desc:"自动抓取 Telegram 频道的媒体文件并下载到本地存储。",tech:["Telegram API","自动化"],links:[{url:"https://telegram.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:5000",label:"🔗 内网"}]},{icon:"📊",name:"Portainer 容器管理",desc:"Docker 容器集群图形化管理面板。",tech:["Docker","管理"],links:[{url:"https://portainer.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:9000",label:"🔗 内网"}]},{icon:"🔄",name:"DDNS-GO",desc:"自动更新域名解析记录，保障内网服务通过域名可达。",tech:["DNS","自动运维"],links:[{url:"https://ddnsgo.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:9876",label:"🔗 内网"}]},{icon:"📂",name:"OpenList 目录索引",desc:"轻量级文件目录索引与分享系统。",tech:["文件管理","分享"],links:[{url:"https://openlist.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:5244",label:"🔗 内网"}]},{icon:"🔗",name:"OmniBox 综合工具",desc:"多功能集成工具箱。",tech:["工具","集成"],links:[{url:"https://omnibox.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:7023",label:"🔗 内网"}]},{icon:"🎥",name:"咪咕视频助手",desc:"咪咕视频资源抓取与下载工具。",tech:["视频","抓取"],links:[{url:"https://migu.deltrivx.com",label:"🌐 公网"},{url:"http://192.168.31.2:1234",label:"🔗 内网"}]},{icon:"🌀",name:"Sub2API",desc:"AI API 网关平台，支持订阅转换与多模型路由。",tech:["API","AI","Gateway"],links:[{url:"http://192.168.31.2:8008",label:"🔗 内网"}]},{icon:"📺",name:"MDC 媒体下载中心",desc:"多平台媒体资源下载与聚合中心。",tech:["媒体","下载"],links:[{url:"http://192.168.31.2:9208",label:"🔗 内网"}]},{icon:"🔐",name:"AllInSSL 证书管理",desc:"SSL 证书全生命周期管理工具。",tech:["SSL","证书"],links:[{url:"http://192.168.31.2:8888/allinssl",label:"🔗 内网"}]},{icon:"🖥️",name:"MDCx 图形界面",desc:"MDCx 媒体下载工具 GUI 版，基于 VNC 远程桌面操作。",tech:["媒体","下载","GUI"],links:[{url:"http://192.168.31.2:5800",label:"🔗 内网"}]},{icon:"⚡",name:"KV Rocks 缓存",desc:"Apache Kvrocks 高性能键值存储，兼容 Redis 协议。",tech:["Kvrocks","Redis"],links:[]},{icon:"🤖",name:"OpenClaw AI",desc:"智能 AI 代理系统，支持多模型切换与自动化任务编排。",tech:["AI Agent","LLM"],links:[]},{icon:"🛡️",name:"FlareSolverr",desc:"Cloudflare 挑战解析代理，为自动化工具提供免验证访问。",tech:["代理","反爬"],links:[]},{icon:"🗄️",name:"PostgreSQL 数据库",desc:"PostgreSQL 17 关系型数据库，为各服务提供可靠的数据存储。",tech:["PostgreSQL","数据库"],links:[]},{icon:"📦",name:"Redis 缓存",desc:"高性能内存缓存数据库，加速服务响应。",tech:["Redis","缓存"],links:[]},{icon:"🌐",name:"Nginx 反向代理",desc:"Web 服务反向代理与负载均衡网关。",tech:["Nginx","代理"],links:[]}];return(()=>{var t=Nr(),n=t.firstChild,o=n.nextSibling;return g(o,()=>e.map((r,a)=>(()=>{var i=Dr(),s=i.firstChild,l=s.firstChild,c=s.nextSibling,p=c.firstChild,d=p.nextSibling,m=d.nextSibling,h=m.nextSibling;return an(i,"animationDelay",a*.1+"s"),g(l,()=>r.icon),g(p,()=>r.name),g(d,()=>r.desc),g(m,()=>r.tech.map(v=>(()=>{var f=Fr();return g(f,v),f})())),g(h,()=>r.links.map(v=>u(Tr,{get href(){return v.url},get label(){return v.label}}))),i})())),t})()}var Rr=w('<section id=articles><div class="section-header reveal"><h2><span class=gradient-text>技术实战</span></h2><p>分享我的思考和见解</p></div><div class=articles-list>'),Mr=w("<div class=article-meta><span class=article-date></span><div class=article-tags>"),Hr=w("<h3>"),Ur=w("<p>"),jr=w("<span class=read-more>阅读更多 →"),Gr=w("<span class=tech-tag>");function Wr(){D(()=>{se(),be()});const e=[{title:"SubStore HomeNet 优化实战：流量显示修复与 ss-direct 8443 独立链路",subtitle:"SubStore · Quantumult X · Shadowsocks over WSS · Cloudflare Tunnel · Nginx 端口隔离",date:"2026-06-12",tags:["SubStore","Quantumult X","Cloudflare","Nginx","HomeNet","WSS"],summary:"完整记录 HomeNet 双节点优化：先修复 SubStore / Quantumult X 流量显示，再将 ss-direct 从 443 拆到 8443 独立 TLS 入口。文章全程域名脱敏，包含 Nginx、Node.js userinfo、QX 节点、gost 验证与回滚方案，新手可按步骤复刻。",slug:"substore-homenet-traffic-8443"},{title:"OpenClaw 记忆优化实战：Ollama Embedding + memory-core 本地化部署",subtitle:"Nomic Embed Text · FnOS Ollama 容器 · 多 OpenClaw 实例 provider 统一管理 · memory-core 语义搜索恢复",date:"2026-06-01",tags:["OpenClaw","Ollama","Embedding","Memory-Core","FnOS","Nomic"],summary:"OpenAI embedding 503 → 自建 Ollama nomic-embed-text 向量化服务。多 OpenClaw 实例 provider 同步管理、Telegram 通道故障排查、ingress 锁文件恢复。从配置到运维全覆盖。",slug:"memory-embed-ollama"},{title:"飞牛系统商店版 OpenClaw 优化实战：启动守护、路径复刻与更新按钮增强",subtitle:"FnOS App Center · trim.openclaw · systemd 兜底自启 · Gateway loopback · 插件优先更新",date:"2026-05-29",tags:["FnOS","OpenClaw","systemd","Bun","Gateway"],summary:"完整记录飞牛系统商店版 OpenClaw 的运行路径、用户权限、systemd 兜底启动脚本、控制面板检查更新按钮逻辑，以及更新前检查商店插件、优先升级渠道插件的优化方案。按文中路径、脚本、运行用户与权限基线，可在另一台 FnOS 设备复刻一致运行环境，避免 root 权限污染。",slug:"fnos-openclaw-store-optimization"},{title:"iOS Quantumult X 异地接入内网：HomeNet 双节点实战指南",subtitle:"Cloudflare Tunnel + Sub-Store + Shadowsocks over WSS · 从零到可用的内网回家方案",date:"2026-05-29",tags:["iOS","Quantumult X","Cloudflare","Sub-Store","内网穿透","Shadowsocks"],summary:"从 Cloudflare Tunnel 创建到 Nginx IPv6 直连加速、Sub-Store 订阅分发，再到 Quantumult X 双节点策略组配置，完整覆盖 iOS 设备异地接入内网的整个链路。双路径冗余：Fast 路径提供最低延迟，CF 路径提供最大兼容性。",slug:"homenet-qx"},{title:"飞牛系统（FnOS）核显温度显示补丁：从原理到实现",subtitle:"Intel iGPU · WebSocket 代理 · JS 注入 · bind-mount · FnOS 资源监控面板适配",date:"2026-05-24",tags:["FnOS","iGPU","Intel","WebSocket","系统补丁"],summary:"Intel 核显在 FnOS 面板中温度显示为空的解决方案。通过 WebSocket 代理拦截资源监控通信，将 CPU 封装温度回填到 GPU 温度字段，配合 JS 注入和 bind-mount 挂载实现无痕补丁。文章附带完整的部署脚本、卸载方法、备份恢复流程和故障排查指南。",slug:"fnos-igpu-temp"},{title:"从零搭建双栈域名体系：Cloudflare Tunnel + 内网穿透完全指南",subtitle:"V4/V6 双栈 · 域名统一接入 · 内外网分流防回环",date:"2026-05-28",tags:["Cloudflare","Tunnel","双栈","内网穿透","DNS"],summary:"详解如何通过 Cloudflare Tunnel 实现域名的 V4+V6 双栈接入，涵盖 CF 前期准备、Tunnel 部署、DNS 批量配置、内网防回环方案，以及最终的双栈验证方法。",slug:"dual-stack-domain"}];return(()=>{var t=Rr(),n=t.firstChild,o=n.nextSibling;return g(o,()=>e.map((r,a)=>u($,{get href(){return`/article/${r.slug}`},class:"article-card reveal tilt-card",style:{animationDelay:a*.1+"s"},get children(){return[(()=>{var i=Mr(),s=i.firstChild,l=s.nextSibling;return g(s,()=>r.date),g(l,()=>r.tags.map(c=>(()=>{var p=Gr();return g(p,c),p})())),i})(),(()=>{var i=Hr();return g(i,()=>r.title),i})(),(()=>{var i=Ur();return g(i,()=>r.summary),i})(),jr()]}}))),t})()}var qr=w(`<section id=article-detail><div class="article-container reveal"><div class=article-header><h1>从零搭建双栈域名体系：Cloudflare Tunnel + 内网穿透完全指南</h1><p class=article-subtitle>V4/V6 双栈 · 域名统一接入 · 内外网分流防回环</p><div class=article-meta><span class=article-date>2026-05-28</span><div class=article-tags><span class=tech-tag>Cloudflare</span><span class=tech-tag>Tunnel</span><span class=tech-tag>双栈</span><span class=tech-tag>内网穿透</span><span class=tech-tag>DNS</span></div></div></div><div class=article-content><h2>一、为什么要做双栈域名？</h2><p>IPv6 已经普及，但很多服务只配置了 IPv4。双栈（Dual Stack）让域名同时支持 IPv4 和 IPv6 访问，用户无论使用哪种协议都能连通。结合 Cloudflare Tunnel，可以在没有公网 IP 的情况下，实现全域名双栈接入。</p><p>实际场景中，家中服务器可能只有 IPv6 公网地址（由运营商分配），而很多用户的网络环境仅支持 IPv4。双栈域名体系让两种网络环境下的用户都能无缝访问你的服务。</p><h2>二、基础架构设计</h2><p>整体架构分两条路径：外网用户通过 Cloudflare 边缘节点（天然双栈）进入 Tunnel，内网用户通过路由器 DNS 重定向直达本机。两条路径互不干扰，避免回环。</p><pre>┌─────────────────────────────────────────────────────────────┐
│  外网用户（IPv4 / IPv6）                                     │
│       ↓                                                       │
...
# 4. 重载 Nginx
nginx -s reload</pre><p>回滚只影响 <code>HomeNet-CF</code> 备用链路，不影响 SubStore 页面，也不影响 <code>HomeNet-Fast</code> 直连节点。</p><h2>十三、总结</h2><p>这次优化的关键不是“换一个端口”这么简单，而是把链路职责拆清楚：</p><ul><li><code>443</code> 保留给页面、订阅和 userinfo。</li><li><code>8443</code> 专门承载 <code>/ss-direct</code> WSS 隧道。</li><li>订阅和 userinfo 使用同一套统计后端。</li><li>流量验证不只看节点连通，还要看计数前后变化。</li></ul><p>对新手来说，最稳的排障方法是逐层验证：先看端口监听，再看 Nginx location，再看 userinfo header，最后用 QX 或 gost 跑真实流量。每一层都有明确输出，问题就不会混在一起。`);function to(){return D(()=>{document.querySelectorAll(".reveal").forEach(e=>e.classList.add("visible")),window.scrollTo(0,0)}),(()=>{var e=eo(),t=e.firstChild,n=t.firstChild;return g(t,u($,{href:"/articles",class:"back-link",children:"← 返回文章列表"}),n),e})()}var no=w('<div style="max-width:400px;margin:100px auto;padding:40px 20px"><h1 style=text-align:center;margin-bottom:30px>登录</h1><form><div style=margin-bottom:20px><label style=display:block;margin-bottom:6px>用户名</label><input type=text style="width:100%;padding:10px;background:#1a1a2e;border:1px solid #333;color:#fff;border-radius:6px"></div><div style=margin-bottom:20px><label style=display:block;margin-bottom:6px>密码</label><input type=password style="width:100%;padding:10px;background:#1a1a2e;border:1px solid #333;color:#fff;border-radius:6px"></div><button type=submit style=width:100%;padding:12px;background:#00d4ff;color:#000;border:none;border-radius:6px;font-weight:bold;cursor:pointer>登录'),ro=w("<p style=color:#ff4444;margin-bottom:15px>");function oo(){if(typeof window>"u")return"/";const e=window.location.hash,t=e.indexOf("?");return t===-1?"/":new URLSearchParams(e.slice(t+1)).get("redirect")||"/"}function so(e){return e.startsWith("http://")||e.startsWith("https://")}function ao(){const[e,t]=T("DeltrivX"),[n,o]=T(""),[r,a]=T(""),i=ft(),{login:s}=Me(),l=async c=>{if(c.preventDefault(),a(""),!e().trim()){a("请输入用户名");return}if(await s(e(),n())){const d=oo();so(d)?(window.open(d,"_blank"),i("/projects",{replace:!0})):d!=="/"?i(d,{replace:!0}):i("/",{replace:!0})}else a("用户名或密码错误，请重试")};return(()=>{var c=no(),p=c.firstChild,d=p.nextSibling,m=d.firstChild,h=m.firstChild,v=h.nextSibling,f=m.nextSibling,b=f.firstChild,_=b.nextSibling,y=f.nextSibling;return d.addEventListener("submit",l),v.$$input=O=>t(O.target.value),_.$$input=O=>o(O.target.value),g(d,(()=>{var O=z(()=>!!r());return()=>O()&&(()=>{var A=ro();return g(A,r),A})()})(),y),N(()=>v.value=e()),N(()=>_.value=n()),c})()}re(["input"]);var io=w('<div class=content style=display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:70vh;text-align:center><div class=code style="font-size:clamp(6rem, 20vw, 10rem);font-weight:900;background:linear-gradient(135deg, var(--accent-1), var(--accent-2), var(--accent-3));-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1;margin-bottom:1rem">404</div><h1 style=font-size:1.5rem;margin-bottom:0.8rem;font-weight:600>页面未找到</h1><p style=color:var(--text-secondary);margin-bottom:2rem;font-size:1rem;line-height:1.6>你访问的页面不存在或已被移除。<br>别担心，让我们回到正轨。');function lo(){return(()=>{var e=io(),t=e.firstChild,n=t.nextSibling;return n.nextSibling,g(e,u($,{href:"/",class:"btn btn-primary",children:"🏠 返回首页"}),null),e})()}en(()=>u(Vn,{get children(){return u(Bn,{get children(){return u(jn,{root:ir,get children(){return[u(F,{path:"/",component:()=>[u(L,{children:"Kris | 个人主页"}),u(V,{name:"description",content:"Kris - 全栈开发者、AI探索者、开源贡献者"}),u(xr,{})]}),u(F,{path:"/about",component:()=>[u(L,{children:"Kris | 关于我"}),u(V,{name:"description",content:"了解 Kris 的背景和经历"}),u(Cr,{})]}),u(F,{path:"/skills",component:()=>[u(L,{children:"Kris | 技能栈"}),u(V,{name:"description",content:"Kris 掌握的技术和工具"}),u(Ir,{})]}),u(F,{path:"/projects",component:()=>[u(L,{children:"Kris | 精选项目"}),u(V,{name:"description",content:"Kris 引以为豪的作品"}),u(Lr,{})]}),u(F,{path:"/articles",component:()=>[u(L,{children:"Kris | 文章"}),u(V,{name:"description",content:"Kris 分享的技术文章与思考"}),u(Wr,{})]}),u(F,{path:"/article/fnos-openclaw-store-optimization",component:()=>[u(L,{children:"Kris | 飞牛系统商店版 OpenClaw 优化实战"}),u(Vr,{})]}),u(F,{path:"/article/homenet-qx",component:()=>[u(L,{children:"Kris | iOS Quantumult X 异地接入内网：HomeNet 双节点实战指南"}),u(Xr,{})]}),u(F,{path:"/article/dual-stack-domain",component:()=>[u(L,{children:"Kris | 双栈域名体系完全指南"}),u(Br,{})]}),u(F,{path:"/article/substore-homenet-traffic-8443",component:()=>[u(L,{children:"Kris | SubStore HomeNet 优化实战：流量显示修复与 8443 独立链路"}),u(to,{})]}),u(F,{path:"/article/memory-embed-ollama",component:()=>[u(L,{children:"Kris | OpenClaw 记忆优化：Ollama Embedding + memory-core"}),u(Zr,{})]}),u(F,{path:"/article/fnos-igpu-temp",component:()=>[u(L,{children:"Kris | FnOS 核显温度显示补丁：从原理到实现"}),u(zr,{})]}),u(F,{path:"/login",component:()=>[u(L,{children:"Kris | 登录"}),u(ao,{})]}),u(F,{path:"*paramName",component:()=>[u(L,{children:"404 - 页面未找到"}),u(lo,{})]})]}})}})}}),document.getElementById("root"));
