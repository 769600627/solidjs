...
变更后:
  ...
  -d '{"model":"nomic-embed-text","input":["测试消息"]}'
→ embeddings: 1 x 768</pre><p>768 维向量正确返回，sqlite-vec 语义搜索库即可正常工作。</p><h2>八、总结</h2><p>通过将 OpenAI 嵌入模型替换为本地 Ollama 的 nomic-embed-text，实现了：</p><ul><li><strong>零成本</strong>：完全本地运行，无 API 调用费用</li><li><strong>零延迟</strong>：同机推理，毫秒级返回</li><li><strong>统一管理</strong>：三个 OpenClaw 实例共享同一嵌入服务</li><li><strong>Provider 维护规范</strong>：openclaw.json 与 models.json 保持同步，避免 Invalid config</li><li><strong>高可用</strong>：避免 OpenAI 503 导致记忆服务中断</li></ul><p>同时本文也记录了多 OpenClaw 实例的统一管理模式、Telegram 通道常见问题及修复方法，可作为 FnOS 上 OpenClaw 运维的参考。`);function Jr(){return D(()=>{document.querySelectorAll(".reveal").forEach(e=>e.classList.add("visible")),window.scrollTo(0,0)}),(()=>{var e=Zr(),t=e.firstChild,n=t.firstChild;return g(t,u(k,{href:"/articles",class:"back-link",children:"← 返回文章列表"}),n),e})()}var eo=w('<div style="max-width:400px;margin:100px auto;padding:40px 20px"><h1 style=text-align:center;margin-bottom:30px>登录</h1><form><div style=margin-bottom:20px><label style=display:block;margin-bottom:6px>用户名</label><input type=text style="width:100%;padding:10px;background:#1a1a2e;border:1px solid #333;color:#fff;border-radius:6px"></div><div style=margin-bottom:20px><label style=display:block;margin-bottom:6px>密码</label><input type=password style="width:100%;padding:10px;background:#1a1a2e;border:1px solid #333;color:#fff;border-radius:6px"></div><button type=submit style=width:100%;padding:12px;background:#00d4ff;color:#000;border:none;border-radius:6px;font-weight:bold;cursor:pointer>登录'),to=w("<p style=color:#ff4444;margin-bottom:15px>");function no(){if(typeof window>"u")return"/";const e=window.location.hash,t=e.indexOf("?");return t===-1?"/":new URLSearchParams(e.slice(t+1)).get("redirect")||"/"}function ro(e){return e.startsWith("http://")||e.startsWith("https://")}function oo(){const[e,t]=T("DeltrivX"),[n,o]=T(""),[r,a]=T(""),i=ft(),{login:s}=Me(),l=async c=>{if(c.preventDefault(),a(""),!e().trim()){a("请输入用户名");return}if(await s(e(),n())){const d=no();ro(d)?(window.open(d,"_blank"),i("/projects",{replace:!0})):d!=="/"?i(d,{replace:!0}):i("/",{replace:!0})}else a("用户名或密码错误，请重试")};return(()=>{var c=eo(),p=c.firstChild,d=p.nextSibling,m=d.firstChild,h=m.firstChild,b=h.nextSibling,f=m.nextSibling,v=f.firstChild,_=v.nextSibling,y=f.nextSibling;return d.addEventListener("submit",l),b.$$input=O=>t(O.target.value),_.$$input=O=>o(O.target.value),g(d,(()=>{var O=z(()=>!!r());return()=>O()&&(()=>{var A=to();return g(A,r),A})()})(),y),N(()=>b.value=e()),N(()=>_.value=n()),c})()}re(["input"]);var so=w('<div class=content style=display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:70vh;text-align:center><div class=code style="font-size:clamp(6rem, 20vw, 10rem);font-weight:900;background:linear-gradient(135deg, var(--accent-1), var(--accent-2), var(--accent-3));-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1;margin-bottom:1rem">404</div><h1 style=font-size:1.5rem;margin-bottom:0.8rem;font-weight:600>页面未找到</h1><p style=color:var(--text-secondary);margin-bottom:2rem;font-size:1rem;line-height:1.6>你访问的页面不存在或已被移除。<br>别担心，让我们回到正轨。');function ao(){return(()=>{var e=so(),t=e.firstChild,n=t.nextSibling;return n.nextSibling,g(e,u(k,{href:"/",class:"btn btn-primary",children:"🏠 返回首页"}),null),e})()}en(()=>u(Vn,{get children(){return u(qn,{get children(){return u(Gn,{root:ir,get children(){return[u(R,{path:"/",component:()=>[u(L,{children:"Kris | 个人主页"}),u(V,{name:"description",content:"Kris - 全栈开发者、AI探索者、开源贡献者"}),u(Sr,{})]}),u(R,{path:"/about",component:()=>[u(L,{children:"Kris | 关于我"}),u(V,{name:"description",content:"了解 Kris 的背景和经历"}),u(Cr,{})]}),u(R,{path:"/skills",component:()=>[u(L,{children:"Kris | 技能栈"}),u(V,{name:"description",content:"Kris 掌握的技术和工具"}),u(Ir,{})]}),u(R,{path:"/projects",component:()=>[u(L,{children:"Kris | 精选项目"}),u(V,{name:"description",content:"Kris 引以为豪的作品"}),u(Lr,{})]}),u(R,{path:"/articles",component:()=>[u(L,{children:"Kris | 文章"}),u(V,{name:"description",content:"Kris 分享的技术文章与思考"}),u(Wr,{})]}),u(R,{path:"/article/fnos-openclaw-store-optimization",component:()=>[u(L,{children:"Kris | 飞牛系统商店版 OpenClaw 优化实战"}),u(Vr,{})]}),u(R,{path:"/article/homenet-qx",component:()=>[u(L,{children:"Kris | iOS Quantumult X 异地接入内网：HomeNet 双节点实战指南"}),u(Xr,{})]}),u(R,{path:"/article/dual-stack-domain",component:()=>[u(L,{children:"Kris | 双栈域名体系完全指南"}),u(qr,{})]}),u(R,{path:"/article/memory-embed-ollama",component:()=>[u(L,{children:"Kris | OpenClaw 记忆优化：Ollama Embedding + memory-core"}),u(Jr,{})]}),u(R,{path:"/article/fnos-igpu-temp",component:()=>[u(L,{children:"Kris | FnOS 核显温度显示补丁：从原理到实现"}),u(zr,{})]}),u(R,{path:"/login",component:()=>[u(L,{children:"Kris | 登录"}),u(oo,{})]}),u(R,{path:"*paramName",component:()=>[u(L,{children:"404 - 页面未找到"}),u(ao,{})]})]}})}})}}),document.getElementById("root"));
